...
const recentActivity = [
  {
    type: "purchase",
    message: "Subscribed to AI Text Analyzer Pro",
    time: "2 hours ago",
  },
  {
    type: "review",
    message: "Received 5-star review on Custom Auth Wrapper",
    time: "5 hours ago",
  },
        ...
        <main className="flex-1 p-6 lg:p-8 overflow-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <Tabs
                value={view}
                onValueChange={(v) => setView(v as "buyer" | "seller")}
              >
                <TabsList>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-medium">{service.name}</p>
                            <p className="text-sm text-muted-foreground">
                              {service.downloads.toLocaleString()} downloads • $
                              {service.revenue.toLocaleString()} earned
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
